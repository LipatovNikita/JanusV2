...
<#if bidList??>
    ...
    <#if numberPage?? || (numberPage > 0) >
        <ul class="pagination">
            <li class="disabled"><a href="/docs/${numberPage-1}"><i class="material-icons">chevron_left</i></a></li>
            ...
            <li class="waves-effect"><a href="/docs/${numberPage+1}"><i class="material-icons">chevron_right</i></a>
            </li>
        </ul>
    </#if>
</#if>
